...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 75 110">
	...
	<g id="header" transform="translate(3,3)">
		<g id="EU-flag">
			<rect width="16" height="11" fill="#0033ff" />
		...
		<g id="energy" transform="translate(18,1.7)" fill="#0033ff">
	...
	<g id="fuel-efficiency" transform="translate(3,30)">
		...
		<g stroke="black" stroke-width="0.1">
			<path d="M 0,16 h 7.75 l 3.25,3.25 l -3.25,3.25 h -7.75 z" fill="#00ff00" />
			<path d="M 0,24 h 9.75 l 3.25,3.25 l -3.25,3.25 h -9.75 z" fill="#8cff00" />
			<path d="M 0,32 h 11.75 l 3.25,3.25 l -3.25,3.25 h -11.75 z" fill="#ffff00" />
			<path d="M 0,40 h 13.75 l 3.25,3.25 l -3.25,3.25 h -13.75 z" fill="#ffb300" />
			<path d="M 0,48 h 15.75 l 3.25,3.25 l -3.25,3.25 h -15.75 z" fill="#ff0000" />
	...
	<g id="wet-grip" transform="translate(39.5,30)">
		...
		<g stroke="black" stroke-width="0.1">
			<path d="M 0,16 h 7.75 l 3.25,3.25 l -3.25,3.25 h -7.75 z" fill="#0066ff" />
			<path d="M 0,24 h 9.75 l 3.25,3.25 l -3.25,3.25 h -9.75 z" fill="#1999ff" />
			<path d="M 0,32 h 11.75 l 3.25,3.25 l -3.25,3.25 h -11.75 z" fill="#59ccff" />
			<path d="M 0,40 h 13.75 l 3.25,3.25 l -3.25,3.25 h -13.75 z" fill="#80e7ff" />
